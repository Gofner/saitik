...
export function Footer() {
  return (
    <footer className="border-t border-border/50 bg-background">
      <div className="mx-auto grid max-w-7xl grid-cols-[1fr_auto_auto_auto] items-center gap-6 px-4 py-8 text-sm text-muted-foreground lg:px-8">
        ...
        {/* Icons — между каталогом и MALMARKET */}
        <div className="flex items-center gap-1.5 justify-self-center">
          <a
            ...
            title="Discord"
          >
            <svg width="20" height="20" viewBox="0 0 245 240" fill="currentColor" aria-hidden="true">
          ...
          <a
            ...
            title="Telegram"
          >
            <svg width="20" height="20" viewBox="0 0 240 240" fill="currentColor" aria-hidden="true">
